...
class Interface(Frame):
    def __init__(self, fenetre=None, **kwargs):
        ...
        self.a_partir = Entry(framebot, width=5).grid(row=6, column=1)
    ...
    def creer(self):
        ...
        var = StringVar()
        nomdurep = Entry(frametop, textvariable=var)
        var.set(r'C:\Users\Wizkalista\Desktop\test')
        nomdurep.grid(row=3, column=3)
        Label(frametop, text="").grid(row=3, column=5)
        Label(frametop, text="").grid(row=6, column=5)
